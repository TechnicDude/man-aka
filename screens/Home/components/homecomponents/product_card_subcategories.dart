...
class ProductCardUiSubCategories extends StatelessWidget {
  // final String imagePath;
  // final String text;
  final ValueChanged<GetproductSubcategoriesModelDatas> onSelected;
  final GetproductSubcategoriesModelDatas model;
  const ProductCardUiSubCategories(
