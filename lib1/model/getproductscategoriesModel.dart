class GetproductscategoriesModel {
  String? status;
  GetproductscategoriesModelData? data;

  GetproductscategoriesModel({this.status, this.data});

  GetproductscategoriesModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    data = json['data'] != null
        ? new GetproductscategoriesModelData.fromJson(json['data'])
        : null;
  }
...
class GetproductscategoriesModelData {
  int? currentPage;
  ...
  GetproductscategoriesModelData(
      {this.currentPage,
      this.data,
      this.firstPageUrl,
      this.from,
  ...
  GetproductscategoriesModelData.fromJson(Map<String, dynamic> json) {
